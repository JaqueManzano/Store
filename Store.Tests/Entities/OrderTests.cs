...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Jaque", "jaque@hotmail.com");
        private readonly Product _product = new Product("Fone de ouvido", 10, true);
        ...
        {
            var expiredDiscount = new Discount(30, DateTime.Now.AddDays(-1));
