...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        {
            var customer = new Customer("Jaque", "jaque@hotmail.com");
        ...
        {
            var customer = new Customer("Jaqueline Manzano", "jaque@hotmail.com");
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_comando_valido_o_pedido_deve_ser_gerado_normalmente()
        {
            var command = new CreateOrderCommand();
